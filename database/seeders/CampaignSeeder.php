...
class CampaignSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $campaignDefinitions = [
            ...
            [
                'reward_name' => 'Gourmet Dinner for Two',
                'description' => 'Collect 14 stamps for a gourmet dinner at a partner restaurant.',
                'code' => 'GOURMT',
                'stamp_target' => 14,
                'reward_cost_target' => 700.00,
                'stamp_slots' => 5,
                'stamp_slot_min' => 1,
                'stamp_slot_max' => 30,
                'stamp_editable_on_plan_purchase' => true,
                'stamp_editable_on_coupon_redemption' => false,
                'marketing_bounty_percentage' => 24,
                'min_plan_index' => 2,
                'category_index' => 0,
            ],
            ...
            [
                'reward_name' => 'Fitness Membership Month',
                'description' => 'Earn 22 stamps for a one-month gym and fitness membership.',
                'code' => 'FITNES',
                'stamp_target' => 22,
                'reward_cost_target' => 2500.00,
                'stamp_slots' => 6,
                'stamp_slot_min' => 1,
                'stamp_slot_max' => 40,
                'stamp_editable_on_plan_purchase' => true,
                'stamp_editable_on_coupon_redemption' => true,
                'marketing_bounty_percentage' => 32,
                'min_plan_index' => 3,
                'category_index' => 4,
            ],
            [
            ...
            [
                'reward_name' => 'Luxury Watch Raffle',
                'description' => 'Collect 35 stamps for entry into the luxury watch raffle draw.',
                'code' => 'LUXWCH',
                'stamp_target' => 35,
                'reward_cost_target' => 8000.00,
                'stamp_slots' => 6,
                'stamp_slot_min' => 1,
                'stamp_slot_max' => 50,
                'stamp_editable_on_plan_purchase' => true,
